    ...
    return (
        <div>
            ...
            <div>
                ...
                <div>
                    <h1 className="mt-12 mb-6 text-2xl text-center text-gray-700">David's Blog</h1>
                    <h3 className="text-center text-xl font-light mb-3 px-6">his weekly blog features David's anointed writing on topics like The Holy Spirit, Healing, Prayer, Spiritual Warfare, Miracles, God's Presence, and more.
                ...
                <div className="px-8">
                    <h1 className="mt-12 mb-6 text-2xl text-center text-gray-700">Latest Post</h1>
                    <img src="/assets/blog.jpg" alt="" />
                    <h1 className="mt-6 mb-12 text-3xl text-center text-gray-700">
                        SOME GOOD NEWS AND SOME BAD NEWS</h1>
                </div>
                <hr className="border-t border-gray-400 mt-4 mb-4 mx-auto w-[85%]" />

                <div>
                    <h1 className="text-center font-bold text-gray-700 text-xl mt-6 mb-3" >RECEIVE DAVID'S BLOG VIA EMAIL</h1>
                    <h4 className="px-6 text-center text-[18px] font-light">
                        To receive David’s Blog weekly via your email inbox, sign up to David’s
                        emailing list and select “Weekly Blog Posts.” In addition to the blog
                        posts, you’ll receive other content and updates.
                    </h4>
