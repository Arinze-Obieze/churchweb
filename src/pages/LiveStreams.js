  ...
  return (
    <div className=" px-4 md:px-[32px]">
      ...
      <h3 className="text-center text-xl font-light mb-3 px-6">
        Livestreams of teachings + our ministry events from around the world.
      </h3>
      ...
      <div className="px-6">
        <div className=" mx-auto md:w-[600px] mt-3">
          <iframe
            width="100%"
            height="315"
            src="https://www.youtube.com/embed/A6hf33n2Ibc"
      ...
      <div className="flex justify-center items-center">
        <button className="py-3 mb-12 px-6 text-white bg-blue-500 mt-6">
      ...
      {/* <div className="sm:px-6 md:w-[600px] mx-auto">
        ...
        <form className="border-2 px-2 mx-8 mb-12 md:mb-24 ">
          ...
          <div>
            <div>
              <h3 className="text-xl mt-4 font-semibold mb-3 text-gray-700">
                PHONE NUMBER*
              </h3>
            ...
            <button className="w-[95%] mx-auto block bg-gray-400 hover:bg-blue-600 text-white mb-6 mt-6 font-bold px-6 py-3">
              Sign Up
            </button>
            <h3 className="text-[12px] w-[230px]">
              Message and data rates may apply. Recurring messages subscription.
              Click to view Terms & Privacy. Available in USA and Canada.
      ...
      <hr className="border-t border-gray-300 mt-4 mx-auto w-[85%] mb-6" />
      <div className=" ">
        <h1 className=" font-bold text-xl  text-center text-gray-800 mt-24">
          WATCH NOW ON THE DHM APP
        </h1>
