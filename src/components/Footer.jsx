...
const Footer = () => {
    return (
        <div >
            ...
            <div className="text-center bg-[#000033] text-white pb-40">
                <h1 className="ml-2 mr-2 pt-6 mb-6">DAVID HERNANDEZ MINISTRIES, PO BOX 39670, <br />  DOWNEY CA 90239, UNITED STATES
                    888.740.1110
                </h1>
                <div>
                    EMAIL
                    <span className="ml-2"> nwitejerry200@hotmail.com</span>
                </div>
            </div>
